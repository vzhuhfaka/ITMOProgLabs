...
def get_col(grid: tp.List[tp.List[str]], pos: tp.Tuple[int, int]) -> tp.List[str]:
    ...
    col = []
    x = pos[1]
    for col_element in grid:
        col.append(col_element[x])
    return col
...
def find_possible_values(grid: tp.List[tp.List[str]], pos: tp.Tuple[int, int]) -> tp.Set[str]:
    ...
    a = set([str(i) for i in range(1, 10)]) - row - col - block
    return a
...
def check_solution(solution: tp.List[tp.List[str]]) -> bool:
    ...
    True
    >>> check_solution([['5', '3', '4', '6', '7', '8', '9', '1', '2'], ['6', '7', '2', '1', '9', '5', '3', '4', '8'], ['1', '9', '8', '3', '4', '2', '5', '6', '7'], ['8', '5', '9', '7', '6', '1', '4', '2', '3'], ['4', '2', '6', '8', '5', '3', '7', '9', '1'], ['7', '1', '3', '9', '2', '4', '8', '5', '6'], ['9', '6', '1', '5', '3', '7', '2', '8', '4'], ['2', '8', '7', '4', '1', '9', '6', '3', '5'], ['3', '4', '5', '2', '8', '6', '1', '8', '9']])
    False
    """
    ...
    for y in range(len(solution)):
        for x in range(len(solution[y])):
            ...
            if len(set(col)) != 9 or len(set(row)) != 9 or len(set(block)) != 9:
                return False
    return True
